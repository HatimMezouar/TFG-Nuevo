        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Añadir Prueba</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="validarProva.php?id=<?php echo $nombre;?>" method="post">
                                    <p>Número Prueba <input type="number" placeholder="Introducir el num prueba" name="num"> </p>
                                    <p>Descripción <input type="text" placeholder="Introducir la descripcion" name="desc"> </p>
                                    <p>Año académico <input type="number" placeholder="Introducir el año académico" name="ano"> </p>
                                    <p>Nota Máxima<input type="number" placeholder="Introducir nota máxima" name="nota"> </p>
