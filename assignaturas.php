...
$assignaturas = "SELECT NOM FROM assignatura";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <h1 <p> <button type="button"  class="btn btn-success">Añadir Curso</button> </p></h1>
                </div>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        <?php $resultado = mysqli_query($conexion, $assignaturas);
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="panel panel-primary">
                    ...
                    <a href="assignatura.php">
                        <div class="panel-footer">
                            <span class="pull-left">Acceder al Curso</span>
